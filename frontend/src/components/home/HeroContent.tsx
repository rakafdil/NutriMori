  ...
  return (
    <div className="min-h-screen w-full bg-white dark:bg-gray-950 flex flex-col relative overflow-hidden font-sans transition-colors duration-500">
      ...
      <nav className="flex justify-between items-center p-6 max-w-7xl mx-auto w-full">
        <div className="flex items-center gap-2 text-emerald-800 dark:text-emerald-400 font-bold text-xl tracking-tight">
          <Activity className="w-6 h-6" />
          <span>NutriFlow</span>
        </div>
        <div className="hidden md:flex gap-6 text-sm font-medium text-gray-600 dark:text-gray-400">
          <button className="hover:text-emerald-700 dark:hover:text-emerald-300 transition">
            Features
          </button>
          <button className="hover:text-emerald-700 dark:hover:text-emerald-300 transition">
            Manifesto
