...
const HeroSection: React.FC = () => {
  ...
  return (
    <div
      className={`transform min-h-screen w-full bg-white dark:bg-gray-950 flex flex-col relative overflow-hidden font-sans transition-colors duration-500`}
    >
      <div className={mounted ? "animate-hero-in" : "opacity-0 translate-y-6"}>
        ...
        <div className="absolute h-full w-full z-0 dark:opacity-80 mt-10">
          <div className="flex justify-between px-4 sm:px-10 md:px-20 lg:px-40 mb-10 md:mb-10">
            <Image
        ...
        {/* Main Content */}
        <main className="relative flex-1 flex flex-col justify-center items-center text-center px-4 md:px-6 max-w-4xl mx-auto mt-10 md:mt-25">
          ...
          <p className="text-lg md:text-xl text-gray-500 dark:text-gray-400 max-w-2xl mb-10 leading-relaxed">
            Catat pola makanmu, biarkan AI membaca ceritanya, dan dapatkan
            insight yang bikin hidupmu makin terarah.
          </p>
      ...
      <style jsx global>{`
        ...
        .animate-hero-in {
          animation: heroIn 600ms cubic-bezier(0.22, 0.8, 0.12, 1) both;
